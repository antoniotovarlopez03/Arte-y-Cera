      ...
      <article className="mx-auto max-w-6xl px-5 pt-6 pb-16">
        <header className="grid gap-10 lg:grid-cols-[minmax(0,35rem)_1fr] lg:items-start lg:gap-14">
          ...
          <div>
            ...
            <div className="textura-pared mt-7 rounded-pieza bg-piedra p-6 sm:p-7">
              <Precio precios={linea.precios} nota={linea.notaPrecio} tamano="grande" />

              <dl className="mt-6 space-y-4 text-sm">
                {linea.medidas && (
                  <div>
                    <dt className="text-ink-soft/70">Tamaño</dt>
                    <dd className="font-medium text-ink">{linea.medidas}</dd>
                  </div>
                )}
                {linea.incluye.length > 0 && (
                  <div>
                    <dt className="text-ink-soft/70">Incluye</dt>
                    <dd>
                ...
                <div>
                  <dt className="text-ink-soft/70">Plazo</dt>
              ...
              <p className="mt-3 text-center text-xs text-ink-soft/70">{site.tiempoRespuesta}</p>
            </div>
          </div>
        </header>
