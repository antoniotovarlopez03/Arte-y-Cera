...
export function TarjetaCategoriaAncha({ categoria }: { categoria: Categoria }) {
  ...
  return (
    <article className="group">
      <Link
        href={categoria.href}
        className="grid items-center gap-8 rounded-pieza border border-sand bg-cream/40 p-4 transition-colors hover:border-gold-deep hover:bg-cream/70 sm:grid-cols-[minmax(0,24rem)_1fr] sm:gap-10 sm:p-6"
      >
        ...
        <div>
          ...
          <p className="mt-5 flex items-baseline gap-2">
            <span className="font-display text-xl font-bold text-verde">
          ...
          <p className="mt-4 inline-flex items-center gap-2 border-b border-verde/25 pb-0.5 text-sm font-medium text-verde transition-colors group-hover:border-verde">
