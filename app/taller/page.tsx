...
export default function PaginaTaller() {
  return (
    <div className="pb-4">
      ...
      <section
        className="textura-pared mx-auto max-w-6xl rounded-pieza bg-piedra px-5 py-20 lg:py-24"
          ...
          {DETALLES.map((detalle) => (
            <li key={detalle.ref}>
              <Link href={detalle.href} className="group block">
                ...
                <p className="mt-3 font-mono text-xs tracking-wide text-ink-soft/70">{detalle.ref}</p>
              </Link>
            </li>
          ))}
        </ul>
      ...
      <section className="textura-pared mx-auto max-w-3xl rounded-pieza bg-salvia px-5 py-16 text-center lg:py-20">
