...
/* La foto de portada es una pieza real del taller, recuperada del WordPress de
   Antonio a 1600 × 1200: una vela de mesa elaborada, sola y enfocada, con el
...
const PORTADA = {
  src: '/images/colecciones/mesa-elaboradas/mesa-elaboradas-01.webp',
  alt: 'Vela de mesa pintada a mano con el rostro de una mujer en rojo, azul y amarillo, sobre una mesa blanca',
  ancho: 1600,
  alto: 1200,
};
      ...
      <section className="border-b border-sand/60 bg-cream/40">
        <div className="lg:grid lg:grid-cols-2 lg:items-stretch">
          <div className={`px-5 py-16 lg:py-28 lg:pr-14 ${SANGRADO}`}>
            <p className="rotulo">Hecho a mano · Pieza única</p>
            ...
            <h1 className="mt-4 font-display text-[clamp(2.25rem,4.4vw,3.5rem)] leading-[1.08] font-bold">
          ...
          <div className="lg:h-full">
            <Image
              ...
              quality={90}
              priority
              className="aspect-4/3 w-full object-cover lg:h-full lg:min-h-[34rem] lg:aspect-auto"
            />
          </div>
        </div>
      </section>
