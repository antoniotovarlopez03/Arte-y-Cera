...
export default function PaginaTaller() {
  return (
    <div className="pb-4">
      ...
      <section
        className="mx-auto max-w-6xl rounded-pieza bg-bosque px-5 py-20 lg:py-24"
      ...
      <section className="mx-auto max-w-3xl rounded-pieza bg-bosque px-5 py-16 text-center lg:py-20">
