...
export function BotonWhatsapp() {
  return (
    <a
      ...
      className="fixed right-4 bottom-4 z-30 flex h-13 w-13 items-center justify-center rounded-full bg-[#25d366] text-white shadow-pieza transition-transform hover:scale-105 print:hidden"
    >
